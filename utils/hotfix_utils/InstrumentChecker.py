...
class InstrumentChecker:
    ...
    def get_parent_epics_branch(self,
        hostname: str,
    ) -> Union[str | bool]:
    ...
    def check_instrument(self
        ...
        (self.commits_upstream_not_on_local_enum, self.commits_upstream_not_on_local_messages) = self.git_branch_comparer(
            self.hostname, changes_on=upstream_branch, subtracted_against="HEAD", prefix=None)
