...
@REM     if exist "%WORKSPACE%\Python3" rd /s /q %WORKSPACE%\Python3
@REM     call %LATEST_PYTHON_DIR%..\genie_python_install.bat %WORKSPACE%\Python3
@REM     if !errorlevel! neq 0 exit /b 1
@REM     set "LATEST_PYTHON3=%WORKSPACE%\Python3\python3.exe"
@REM )
